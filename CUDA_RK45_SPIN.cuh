...
__device__ /*__host__*/ double CUDA_polcalc_SPIN( double bb1x, double bb1y, double bb1z, double spinor[]);
...
__device__ /*__host__*/ int CUDA_derivs_SPIN( double t, double spinor[], double dspinordt[], double BField[], double t_START, double inter[]);
__device__ /*__host__*/ int CUDA_rkck_SPIN( double *d_IO, int *d_IO_INT, int vi_RECORD, double t, double spinor[], double dspinordt[], double h, double spinorerr[], double spinorout[], double BField[], double inter[]); 
__device__ /*__host__*/ int CUDA_rkqs_SPIN( double *d_IO, int *d_IO_INT, int vi_RECORD, double spinor[], double dspinordt[], double *t, double htry, double *hdid, double *hnext, double spinor_scal[], double BField[], double epsilon[], int *rkqs_steps, double inter[]); //);
...
__device__ /*__host__*/ int CUDA_RECORD_SPIN( double *d_IO, int *d_IO_INT, int *p_vi_RECORD, 
...
__device__ /*__host__*/ int CUDA_rkqs_SINGLE_ATTEMPT_SPIN(
  ...
  double spinor[],   double dspinordt[],   double *t,   double htry, 
  double *hdid,   double *hnext,   double spinor_scal[], double BField[], 
